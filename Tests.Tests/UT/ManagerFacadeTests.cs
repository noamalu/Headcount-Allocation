...
namespace UT.Tests
{
    ...
    public class ManagerFacaseTests
    {
        ...
        public void AddTicket_ShouldAddTicket()
        {
            ...
            int ticketId = manager.AddTicket(employeeId, DateTime.Today, DateTime.Today.AddDays(5), "Vacation", new Reason(Reasons.LongVacation));
        ...
        public void CloseTicket_ShouldMarkTicketClosed()
        {
            ...
            int employeeId = manager.GetAllEmployees()[0].EmployeeId;
            int ticketId = manager.AddTicket(employeeId, DateTime.Today, DateTime.Today.AddDays(5), "Closure", new Reason(Reasons.Other));
